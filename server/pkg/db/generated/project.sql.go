...
INSERT INTO project (
    ...
    $1, $2, $3, $4, $5, $6, $7, $8, $9
) RETURNING id, workspace_id, title, description, icon, status, lead_type, lead_id, created_at, updated_at, priority, repo_path
`
...
SELECT id, workspace_id, title, description, icon, status, lead_type, lead_id, created_at, updated_at, priority, repo_path FROM project
WHERE id = $1
`
